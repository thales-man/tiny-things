...
namespace Tiny.Framework.Services.Internal
{
    ...
    /// </summary>
    internal sealed class PlatformPathOperationsAdapter :
        ...
        IAdaptPlatformPathOperations
    {
        ...
        {
            var radius = (int)(frame.Width / 2);
            PathOperations.AddEllipseInRect(new CGRect((nfloat)frame.GetMidX() - radius, (nfloat)frame.GetMidY() - radius, 2.0 * radius, 2.0 * radius));
        }
